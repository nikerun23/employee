...
$(document).ready(function() {
	...
	$("button.picture").on("click", function() {
		...
		$.post("ajaxpicture", {employeeId:employeeId},  function(data) {
			...
			//이미지 동적 출력 과정 추가
			$("div#pictureModal img").attr("src", "${pageContext.request.contextPath}/resources/picture/"+data);
		...
		<div style="margin-bottom: 1%;">
			...
			<div>
				<ul class="nav nav-pills nav-justified ">
					<li class="active"><a href="employeelist">직원관리</a></li>
					<li><a href="regionlist">지역관리</a></li>
					<li><a href="departmentlist">부서관리</a></li>
					<li><a href="positionlist">직위관리</a></li>
					
					<%-- 세션 정보를 EL 표현으로 출력 --%>
					<li><a href="logout" style="color: red">${sessionScope.adminloginkey} 로그아웃</a></li>
				...
				<div class="panel-body">
					...
					<form class="form-inline" role="form" method="post">
						<select class="form-control" id="key" name="key">
							<option value="employeeId">번호</option>
							...
							<tr>
							 ...
							 <tr>
								...
								<td>${emp.birthday}</td>
						 		...
						 		<td><a href="employeeupdateform?employeeId=${emp.employeeId}" role="button" class="btn btn-default btn-xs">수정</a></td>
					...
					<form class="form-inline" role="form" method="post">
						<a href="employeeinsertform" class="btn btn-default">Add</a>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form role="form" action="employeepictureinsert" method="post"
