...
$(document).ready(function() {
	...
	$("button.update").on("click",function(){
		...
		$("#insertUpdateForm input#positionId").val($(this).val());
		$("#insertUpdateForm input#positionName").val($(this).parents("tr").find("span#1").text()); 
		$("#insertUpdateForm input#minBasicPay").val($(this).parents("tr").find("span#2").text());
	});
				...
				<form role="form" action="positioninsert.it" method="post">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="positionId"
							name="positionId" value="" placeholder="직위번호 (수정시 사용)"
			...
			<div class="panel-body">
				<table class="table">
					...
					<tbody>
						...
						<tr>
							<td>1</td>
							<td><span id="1">사원</span></td>
							<td><span id="2">1,000,000</span></td>
						...
						<tr>
							...
							<td><span id="1">${position.positionName}</span></td>
							<td><span id="2"><fmt:formatNumber value="${position.minBasicPay}" groupingUsed="true" /></span></td>
